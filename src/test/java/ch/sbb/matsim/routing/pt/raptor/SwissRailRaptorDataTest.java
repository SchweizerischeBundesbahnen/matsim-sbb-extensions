...
public class SwissRailRaptorDataTest {
    ...
    public void testTransfersFromSchedule() {
        ...
        RaptorParameters raptorParameters = RaptorUtils.createRaptorParameters(f.config);
        SwissRailRaptorData data = SwissRailRaptorData.create(f.schedule, raptorParameters, f.network);
        ...
        SwissRailRaptorData data2 = SwissRailRaptorData.create(f.schedule, raptorParameters, f.network);
        ...
        SwissRailRaptorData data3 = SwissRailRaptorData.create(f.schedule, raptorParameters, f.network);
        ...
        SwissRailRaptorData data4 = SwissRailRaptorData.create(f.schedule, raptorParameters, f.network);
