...
public class SwissRailRaptorDataTest {
    ...
    public void testTransfersFromSchedule() {
        ...
        SwissRailRaptorData data = SwissRailRaptorData.create(f.schedule, raptorConfig);
        ...
        SwissRailRaptorData data2 = SwissRailRaptorData.create(f.schedule, raptorConfig);
        ...
        SwissRailRaptorData data3 = SwissRailRaptorData.create(f.schedule, raptorConfig);
        ...
        SwissRailRaptorData data4 = SwissRailRaptorData.create(f.schedule, raptorConfig);
